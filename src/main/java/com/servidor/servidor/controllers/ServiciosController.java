...
public class ServiciosController {
    ...
    public ResponseEntity<String>RegistrarServicio(@RequestParam String Nombre_serv, int Id_User, int Id_negocio){
        servicioDao.GuardarServicio(Nombre_serv, Id_User, Id_negocio);
